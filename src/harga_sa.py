...
class Harga:
    ...
    def show_prices(self):
        if self.current_widget != None:
            self.window.remove(self.current_widget)
           
        self.window.add(self.prices)
        self.current_widget = self.prices
        
    def show_loading(self):
        if self.current_widget != None:
            self.window.remove(self.current_widget)
            
        self.window.add(self.loading)
        self.current_widget = self.loading
    
    def show_error(self):
        if self.current_widget != None:
            self.window.remove(self.current_widget)
            
        self.window.add(self.error)
        self.current_widget = self.error
